        ...
        <footer class="pt-4 border-t border-border">
                ...
                <form method="POST" action="{{ url('/likes/' . $post->id) }}" class="mb-4">
                    ...
                    <div class="flex flex-wrap justify-between gap-2">
                        <button type="submit" name="reaction" value="like"
                            class="w-12 h-12 rounded-full hover:bg-accent cursor-pointer {{ $reaction === 'like' ? 'ring-2 ring-accent' : '' }}">
                            👍
                        </button>
                        <button type="submit" name="reaction" value="love"
                            class="w-12 h-12 rounded-full cursor-pointer hover:bg-accent {{ $reaction === 'love' ? 'ring-2 ring-accent' : '' }}">
                            ❤️
                        </button>
                        <button type="submit" name="reaction" value="haha"
                            class="w-12 h-12 rounded-full hover:bg-accent cursor-pointer {{ $reaction === 'haha' ? 'ring-2 ring-accent' : '' }}">
                            😂
                        </button>
                        <button type="submit" name="reaction" value="wow"
                            class="w-12 h-12 rounded-full hover:bg-accent cursor-pointer {{ $reaction === 'wow' ? 'ring-2 ring-accent' : '' }}">
                            😮
                        </button>
                        <button type="submit" name="reaction" value="sad"
                            class="w-12 h-12 rounded-full hover:bg-accent cursor-pointer {{ $reaction === 'sad' ? 'ring-2 ring-accent' : '' }}">
                            😢
                        </button>
                        <button type="submit" name="reaction" value="angry"
                            class="w-12 h-12 rounded-full hover:bg-accent cursor-pointer {{ $reaction === 'angry' ? 'ring-2 ring-accent' : '' }}">
                            😡
                        </button>
                    </div>
            ...
            <ul class="flex flex-wrap gap-2">
                @forelse ($post->likes as $user)
                    <li class="flex items-center gap-1 text-sm text-border">
                ...
                @empty
                    <span class="text-sm text-border">
